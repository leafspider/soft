	...
	<html>
	  <head>
	    ...
	    <style>
			...
			table.grid {margin:10px 15px;border:2px solid black;border-top:0px;border-left:0px;background-color:#e5f0ff;}
			...
			.firstcol {border:2px solid black;border-left:0px;font-weight:bold;font-size:0.8em;padding:0px 30px;white-space:nowrap;}
			.firstrowcol {
				border-top:0px;
			...
			.mention {background-color:#fed330;height:30px;width:30px;border-radius:3px;position:relative;}
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<td class="cell firstrowcol">										
					...
					<div class="twitter-unrestricted" style="display:none;margin-left:-20px"><a style="padding:0px;border-radius:3px;" target="_blank" href="http://twitter.com/{.}"><xsl:value-of select="." /></a></div>
				</td>
			</xsl:otherwise>
		</xsl:choose>
