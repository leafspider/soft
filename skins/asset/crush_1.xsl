...
//	  var closevals = [<xsl:value-of select="close" />];
//	  var closearray = closevals.split(',');
//	  alert(closearray.length);
//	  var lablen = Math.floor(closearray.length / 10);
