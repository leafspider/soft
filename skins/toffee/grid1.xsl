	...
	<html>
	  <head>
	    ...
	    <style>
			...
			.cornercell {border:0px 2px 2px 0px solid black;text-align:left;font-weight:bold;font-size:3.0em;position:absolute;top:65px;left:30px;}
			...
			.gnature {height:20px;width:20px;position:absolute;color:white;text-align:center;vertical-align:center;background-color:green;border-radius:3px;}
			...
			.mention2 {background-color:#fed330;height:80px;width:202px;border-radius:3px;margin-top:10px;position:relative;left:-25px;top:5px;}
			.gruledesc {width:55px;vertical-align:top;font-size:0.25em;display:inline-block;padding-top:5px;padding-left:3px;margin-left:2px;text-align:left;}
			.rruledesc {width:55px;vertical-align:top;font-size:0.25em;display:inline-block;padding-top:5px;padding-left:3px;margin-left:2px;text-align:left;}
			.gnature2 {vertical-align:top;height:13px;width:15px;color:white;text-align:center;background-color:green;border-radius:3px;}
			.rnature2 {vertical-align:top;height:13px;width:15px;color:white;text-align:center;background-color:red;border-radius:3px;}
		</style>
		...
		<xsl:choose>
			<xsl:when test=".=''">
				<td class="cornercell">
					...
					<div class="mention2">
						<div class="gruledesc"><div class="gnature2">Le</div><div>long equity</div></div>
						<div class="gruledesc"><div class="gnature2">Lc</div>long call</div>
						<div class="gruledesc"><div class="gnature2">Sp</div>short put</div>
						<div class="rruledesc"><div class="rnature2">Se</div>short equity</div>
						<div class="rruledesc"><div class="rnature2">Sc</div>short call</div>
						<div class="rruledesc"><div class="rnature2">Lp</div>long put</div>
					</div>
					
					<div style="font-size:0.5em;position:relative;top:20px;"><xsl:value-of select="/toffee/query" /></div>
