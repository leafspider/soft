<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/cherrypicks" xml:space="preserve">	

	<html>
		<head>
			<title>Carrierpicks</title>
		  ...
		  <style> 
		    ...
		    td {text-align:left;padding:2px 5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
				...
				.pick a {color:white;}
				.pick-ticker {font-size:0.8em;width:90px;padding:2px 4px;display:inline-block;color:white;border-radius:3px;}
			</style>
		</head>	
		...
		<form>
			...
			<table border="0" width="50%">
				<tr style="font-size:1.2em;text-align:center;">
					<th colspan="2" style="text-align:left;padding:30px 0px 0px 100px"><nobr><b><h1>Carrier Picks</h1></b></nobr></th>
				</tr>						
				<tr>				
					<td valign="top">						
	...
	<xsl:template match="pick">		
			<a target="_blank" href="/soft/asset/jake/{@ticker}/crush.htm?years=1" title="{@cherry}">
				<div class="pick-ticker" style="color:black;background-color:{@cherryColor}"><xsl:value-of select="@ticker" /></div>
			</a>
	</xsl:template>
