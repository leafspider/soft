<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/crushpicks" xml:space="preserve">	
		...
		<form>
			...
			<table border="0" width="100%">
				<tr style="font-size:1.2em;text-align:center;">
					<th colspan="2" style="text-align:left;padding:30px 0px 0px 50px"><nobr><b><h1>Crush</h1></b></nobr></th>
				</tr>						
				<tr>				
					<td valign="top">
	...
	<xsl:template match="pick">		
			<!--a target="_blank" href="/soft/asset/jake/{@ticker}/crush.htm?years=1" title="{@ticker} {@crush}%" style="position:absolute;top:{1100-10*@crush}px;left:{100+30*@pear}px;"-->
			<a target="_blank" href="/soft/asset/jake/{@ticker}/crush.htm?years=1" title="{@ticker} {@crush}%">
				<div class="pick-ticker" style="border:1px solid #{@pearColor};color:black;background-color:{@crushColor}"><nobr>							
				<xsl:choose>
