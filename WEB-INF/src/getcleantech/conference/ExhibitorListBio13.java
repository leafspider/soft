...
public class ExhibitorListBio13 extends ExhibitorList
{
...
//		test1();
	...
	public static void test2()
	{
		...
		{	
			...
			String fname = ExhibitorListBio13.class.getSimpleName();
...
//				Log.infoln("name,description,,website,,,,address2,address1,phone,addressCity,addressState" );
			...
			for (int i=0; i<100;i++)
			{
				ExhibitorList exlist = new ExhibitorListBio13();
				exlist.setEventName(fname);			
				exlist.setPageNum(i);
				exlist.populate();
...
//		return "http://www.globalpowergen-community.com/index.php5?path=Visitor&Action=showCompanies&fair[]=983&fair[]=918&fair[]=993&fair[]=984&fair[]=954&fid=" + rnd + "1c03c02766ecc6592b9f3be0521e09&sfr=1&viewmode=list&order=1&&offset=" + (pageNum*100) + "&limit=100";
		return "http://bio13.mapyourshow.com/5_0/exhibitor_results.cfm?alpha=%40&type=alpha&page=" + pageNum + "#GotoResults";
	}
...
//		String qlink = "p.result-owner a";
		String qlink = "td[class=mys-elastic mys-left] a";
...
//		Log.infoln( doc.text() );
		...
		while(els.hasNext())
		{
			...
			String rnd = "" + (int) Math.floor(Math.random() * 99);			
			String href = el.attr("href");
			href = "http://bio13.mapyourshow.com" + href.substring(0,href.length()-rnd.length()) + rnd; 
			links.add(href);
//			Log.infoln("http://bio13.mapyourshow.com" + href);
		}
	}
}
