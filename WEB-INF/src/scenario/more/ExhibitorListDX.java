...
public class ExhibitorListDX extends ExhibitorList
{	
	...
	public static void test2()
	{
		...
		{	
			...
			String fname = ExhibitorListDX.class.getSimpleName();
			File exhibitorFile = new File( "C:\\Workspace\\Ultra\\Nick\\DX\\exhibitors_" + fname + ".csv" );
...
//			Log.report = Util.getPrintStream(listFile.getAbsolutePath());
	...
	public static void test1()
	{
		...
		{	
			...
			ExhibitorList exlist = new ExhibitorListDX();
