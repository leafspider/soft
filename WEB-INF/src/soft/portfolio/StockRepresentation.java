...
public abstract class StockRepresentation extends Representation
{
	public static String resource = "stock";
    public String getResource() { return resource; }

    public static StockRepresentation dispatch( HttpServletRequest request ) throws RepresentationException
    {
       	StockRepresentation rep = null;           	
