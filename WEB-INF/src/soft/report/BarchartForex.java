...
public class BarchartForex extends BarchartFutures
{
	@Override
...
//			Log.infoln(page.getHtml());
			...
			File file = new File( page.getOutputFolder().getAbsolutePath() + "\\output.htm");
	...
	public String getUrl() 
	{
		if( url == null )
		{
			...
			{
				url = "http://old.barchart.com/forex/US_Dollar/USD";
			}
...
//				downloader.setPassword("bernouilli27");
			...
			html += "<table>" +
					"<tr>" + 
					" <th class='spacer'></th>" + 
					" <th colspan='2' class='pagetitle'><h1>Forex Daily Summary: " + reportDate + "</h1></th>" +  
					"</tr>" + 
					"<tr><td></td><td>";
...
//				Log.infoln("cells.size=" + cells.size() );
				...
				while( rowsit.hasNext())
				{
					...
					Element lastCell = row.select( "td:eq(8)" ).first();
	...
	*/
	...
	public File getOutputFolder() {
		if( outputFolder == null )
		{
			...
			outputFolder = new File( Folders.forexFolder() + "\\" + Asset.crushDate( now ) );
			outputFolder.mkdirs();
