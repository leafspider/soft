...
public class BarchartFutures extends BarchartReport
{
	@Override
	...
	public static void main ( String[] args )
	{
		try
		{
			BarchartFutures page = new BarchartFutures();
			Log.debug = true;
...
//			Log.infoln(page.getHtml());
	...
	public String getUrl()
	{
		if( url == null )
		{
			...
			url = url.replaceAll( "www.barchart", "old.barchart" );
		}
		return url;
	}
...
//			reportDate = doc.select( ".time-period-wrapper" ).first().text();	
			...
			html += "<table>" +
					"<tr>" + 
					" <th class='spacer'></th>" + 
					" <th colspan='2' class='pagetitle'><h1>Futures Daily Summary: " + reportDate + "</h1></th>" +  
					"</tr>" + 
					"<tr><td></td><td>";
