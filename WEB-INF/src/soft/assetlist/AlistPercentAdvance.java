...
public class AlistPercentAdvance extends AlistPercentDecline
{
	public String url = "http://old.barchart.com/stocks/percentadvance.php";
...
//		String qtitle = "form.yfi_biz_form table tr td font";
		...
		setTitle( "Percent Advance " + format.format(calendar.getTime()) );
		setId(getTitle());
