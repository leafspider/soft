...
public abstract class Resource extends HttpServlet {
    ...
    */
    ...
    public boolean handleRequest() throws ServletException, IOException  {
    	...
    	try {
	    	...
	    	Resource servlet = dispatch( getRequest().getPathInfo() );    		
	    	if ( servlet != null ) {
    ...
    public Resource dispatch( String pathInfo ) throws ServletException, IOException 
    {
